// RTES Exercise-1 Synthetic Load Generation
// Code modified by: Rushi James Macwan
//
// Original Author: Sam Siewert, September 2016
//
...
/////////////////////////////////
The value for the Fib Test Cycles
has been modified by me (Rushi
James Macwan) for my RTES
Exercise-1 submission. The
modifications here brings the 
code output values close to 
10ms and 20ms as required.

#define FIB_TEST_CYCLES (635)
