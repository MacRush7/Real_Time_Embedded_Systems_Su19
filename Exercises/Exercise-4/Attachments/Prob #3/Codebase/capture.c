...
static int              frame_count = 30; // No. of frames created by the program execution
...
{ 
	...
	char sppm_dumpname[]="test00000000.ppm";
	char sppm2_dumpname[]="testsharp000.ppm";
...

	{
		if(var<=9)
		{
			sppm_dumpname[11] = '0' + var;
			sppm2_dumpname[11] = '0' + var;
		}

		if(var>=10 && var<=19)
		{
			sppm_dumpname[11] = '0' + (var-10);
			sppm2_dumpname[11] = '0' + (var-10);
			sppm_dumpname[10] = '1' ;
			sppm2_dumpname[10] = '1';
		}
		...
		if(var>=20 && var<30)
		{
			sppm_dumpname[11] = '0' + (var-20);
			sppm2_dumpname[11] = '0' + (var-20);
			sppm_dumpname[10] = '2' ;
			sppm2_dumpname[10] = '2';
		}
		...
		argv[1] = sppm_dumpname;
		argv[2] = sppm2_dumpname;
...
#endif
			syslog(LOG_CRIT, "Usage: sharpen input_file.ppm output_file.ppm\n");
			exit(-1);
		}
		else
		{
...
#ifdef PRINTF
		printf("sharpened file: %d...\n", var);
#endif
		syslog(LOG_CRIT, "sharpened file: %d...\n", var);
